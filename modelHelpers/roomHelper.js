...
var createJoin = function (data, socket, callback){
	var newRoom = new roomModel(data);
	newRoom.save(callback);
};
...
var findOneJoin = function (data, socket, callback){
	roomModel.findOne(data, callback);
}
 ...
 *
 */
var addUser = function(room, userId, socket, callback){
 ...
 *
 */
var getUsers = function(room, userId, socket, callback){
